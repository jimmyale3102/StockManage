        ...
        <div class="wrapper">
            ...
            <div id="content" class="background-page">
                ...
                <div class="contenido">
                    ...
                    <h1 class="titleCreate">Facturas de Venta</h1>
                ...
                <!--Contenido de listar producto-->
                    <div class="table table-responsive" >
                        <table class="table table-light text-font table-sm"id="tabla_productos">
                            ...
                            <tbody>
                                <?php
                                $consultaProducto=mysqli_query($link,"SELECT factura_id, CONCAT(c.nombre,' ',c.apellido) as cliente, empleado, saldo, subtotal,total  from cliente c natural join (select factura_id,cliente_id, CONCAT(e.nombre,' ',e.apellido) AS empleado, saldo,subtotal,total from factura natural join empleado e)df;");
                    ...
                    <p>
                     ...
                     <form>
                        ...
                        <button type="button" class="btn btn-ambar" onclick=" location.href='/ProyectoBases2/paginas/factura/CreateSell.php' " value="Vamos" name="boton" /> Crear factura de venta</button>
                        <!-- Botón de inicio -->
